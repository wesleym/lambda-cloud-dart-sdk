...
class FirewallsApi {
  FirewallsApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> createFirewallRulesetWithHttpInfo(FirewallRulesetCreateRequest firewallRulesetCreateRequest,) async {
  ...
  Future<CreateFirewallRuleset200Response?> createFirewallRuleset(FirewallRulesetCreateRequest firewallRulesetCreateRequest,) async {
    final response = await createFirewallRulesetWithHttpInfo(firewallRulesetCreateRequest,);
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'CreateFirewallRuleset200Response',) as CreateFirewallRuleset200Response;
  ...
  Future<Response> deleteFirewallRulesetWithHttpInfo(String id,) async {
    // ignore: prefer_const_declarations
    final path = r'/api/v1/firewall-rulesets/{id}'
      .replaceAll('{id}', id);
  ...
  Future<DeleteSSHKey200Response?> deleteFirewallRuleset(String id,) async {
    final response = await deleteFirewallRulesetWithHttpInfo(id,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'DeleteSSHKey200Response',) as DeleteSSHKey200Response;
  ...
  Future<FirewallRulesList200Response?> firewallRulesList() async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'FirewallRulesList200Response',) as FirewallRulesList200Response;
  ...
  Future<Response> firewallRulesSetWithHttpInfo(FirewallRulesPutRequest firewallRulesPutRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/api/v1/firewall-rules';
  ...
  Future<FirewallRulesList200Response?> firewallRulesSet(FirewallRulesPutRequest firewallRulesPutRequest,) async {
    final response = await firewallRulesSetWithHttpInfo(firewallRulesPutRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<FirewallRulesetsList200Response?> firewallRulesetsList() async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'FirewallRulesetsList200Response',) as FirewallRulesetsList200Response;
  ...
  /// * [String] id (required):
  ///   The unique identifier (ID) of the firewall ruleset
  Future<Response> getFirewallRulesetWithHttpInfo(String id,) async {
    // ignore: prefer_const_declarations
    final path = r'/api/v1/firewall-rulesets/{id}'
      .replaceAll('{id}', id);
  ...
  Future<CreateFirewallRuleset200Response?> getFirewallRuleset(String id,) async {
    final response = await getFirewallRulesetWithHttpInfo(id,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<GetGlobalFirewallRuleset200Response?> getGlobalFirewallRuleset() async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'GetGlobalFirewallRuleset200Response',) as GetGlobalFirewallRuleset200Response;
  ...
  Future<Response> updateFirewallRulesetWithHttpInfo(String id, FirewallRulesetPatchRequest firewallRulesetPatchRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/api/v1/firewall-rulesets/{id}'
      .replaceAll('{id}', id);
  ...
  Future<CreateFirewallRuleset200Response?> updateFirewallRuleset(String id, FirewallRulesetPatchRequest firewallRulesetPatchRequest,) async {
    final response = await updateFirewallRulesetWithHttpInfo(id, firewallRulesetPatchRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> updateGlobalFirewallRulesetWithHttpInfo(GlobalFirewallRulesetPatchRequest globalFirewallRulesetPatchRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/api/v1/firewall-rulesets/global';
  ...
  Future<GetGlobalFirewallRuleset200Response?> updateGlobalFirewallRuleset(GlobalFirewallRulesetPatchRequest globalFirewallRulesetPatchRequest,) async {
    final response = await updateGlobalFirewallRulesetWithHttpInfo(globalFirewallRulesetPatchRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
