...
class InstancesApi {
  ...
  Future<Response> getInstanceWithHttpInfo(String id,) async {
    // ignore: prefer_const_declarations
    final path = r'/api/v1/instances/{id}'
      .replaceAll('{id}', id);
  ...
  Future<GetInstance200Response?> getInstance(String id,) async {
    final response = await getInstanceWithHttpInfo(id,);
  ...
  Future<Response> launchInstanceWithHttpInfo(InstanceLaunchRequest instanceLaunchRequest,) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [InstanceLaunchRequest] instanceLaunchRequest (required):
  Future<LaunchInstance200Response?> launchInstance(InstanceLaunchRequest instanceLaunchRequest,) async {
    final response = await launchInstanceWithHttpInfo(instanceLaunchRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'LaunchInstance200Response',) as LaunchInstance200Response;
  ...
  Future<ListInstanceTypes200Response?> listInstanceTypes() async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'ListInstanceTypes200Response',) as ListInstanceTypes200Response;
  ...
  Future<Response> postInstanceWithHttpInfo(String id, InstanceModificationRequest instanceModificationRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/api/v1/instances/{id}'
      .replaceAll('{id}', id);
  ...
  ///
  /// * [InstanceModificationRequest] instanceModificationRequest (required):
  Future<GetInstance200Response?> postInstance(String id, InstanceModificationRequest instanceModificationRequest,) async {
    final response = await postInstanceWithHttpInfo(id, instanceModificationRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> restartInstanceWithHttpInfo(InstanceRestartRequest instanceRestartRequest,) async {
    // ignore: prefer_const_declarations
  ...
  Future<RestartInstance200Response?> restartInstance(InstanceRestartRequest instanceRestartRequest,) async {
    final response = await restartInstanceWithHttpInfo(instanceRestartRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'RestartInstance200Response',) as RestartInstance200Response;
  ...
  Future<Response> terminateInstanceWithHttpInfo(InstanceTerminateRequest instanceTerminateRequest,) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [InstanceTerminateRequest] instanceTerminateRequest (required):
  Future<TerminateInstance200Response?> terminateInstance(InstanceTerminateRequest instanceTerminateRequest,) async {
    final response = await terminateInstanceWithHttpInfo(instanceTerminateRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'TerminateInstance200Response',) as TerminateInstance200Response;
