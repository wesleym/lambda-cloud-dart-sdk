...
class AddSSHKey200ResponseData {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AddSSHKey200ResponseData &&
    other.id == id &&
    other.name == name &&
  ...
  @override
  String toString() => 'AddSSHKey200ResponseData[id=$id, name=$name, publicKey=$publicKey, privateKey=$privateKey]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AddSSHKey200ResponseData[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AddSSHKey200ResponseData[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AddSSHKey200ResponseData> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<AddSSHKey200ResponseData>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AddSSHKey200ResponseData>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AddSSHKey200ResponseData.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
