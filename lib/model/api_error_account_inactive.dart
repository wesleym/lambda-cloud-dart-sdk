...
class ApiErrorAccountInactive {
  ...
  ApiErrorAccountInactive({
    ...
    this.suggestion = 'Make sure you have verified your email address and have a valid payment method. Contact Support if problems continue.',
  });
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ApiErrorAccountInactive &&
    other.code == code &&
  ...
  @override
  String toString() => 'ApiErrorAccountInactive[code=$code, message=$message, suggestion=$suggestion]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ApiErrorAccountInactive[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ApiErrorAccountInactive[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ApiErrorAccountInactive> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<ApiErrorAccountInactive>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ApiErrorAccountInactive>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ApiErrorAccountInactive.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
