...
class ApiErrorDuplicate {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ApiErrorDuplicate &&
    other.code == code &&
  ...
  @override
  String toString() => 'ApiErrorDuplicate[code=$code, message=$message, suggestion=$suggestion]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ApiErrorDuplicate[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ApiErrorDuplicate[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ApiErrorDuplicate> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<ApiErrorDuplicate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ApiErrorDuplicate>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ApiErrorDuplicate.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
