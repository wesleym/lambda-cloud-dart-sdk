...
class ApiErrorFileSystemInWrongRegion {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ApiErrorFileSystemInWrongRegion &&
    other.code == code &&
  ...
  @override
  String toString() => 'ApiErrorFileSystemInWrongRegion[code=$code, message=$message, suggestion=$suggestion]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ApiErrorFileSystemInWrongRegion[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ApiErrorFileSystemInWrongRegion[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ApiErrorFileSystemInWrongRegion> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, ApiErrorFileSystemInWrongRegion> mapFromJson(dynamic json) {
  ...
  static Map<String, List<ApiErrorFileSystemInWrongRegion>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ApiErrorFileSystemInWrongRegion>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ApiErrorFileSystemInWrongRegion.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
