...
class ApiErrorFilesystemInUse {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ApiErrorFilesystemInUse &&
    other.code == code &&
  ...
  @override
  String toString() => 'ApiErrorFilesystemInUse[code=$code, message=$message, suggestion=$suggestion]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ApiErrorFilesystemInUse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ApiErrorFilesystemInUse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ApiErrorFilesystemInUse> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<ApiErrorFilesystemInUse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ApiErrorFilesystemInUse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ApiErrorFilesystemInUse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
