...
class ApiErrorFirewallRulesetInUse {
  ...
  ApiErrorFirewallRulesetInUse({
    ...
    this.suggestion = 'Terminate all instances that are using the ruleset before deleting it.',
  });
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ApiErrorFirewallRulesetInUse &&
    other.code == code &&
  ...
  @override
  String toString() => 'ApiErrorFirewallRulesetInUse[code=$code, message=$message, suggestion=$suggestion]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ApiErrorFirewallRulesetInUse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ApiErrorFirewallRulesetInUse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ApiErrorFirewallRulesetInUse> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<ApiErrorFirewallRulesetInUse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ApiErrorFirewallRulesetInUse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ApiErrorFirewallRulesetInUse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
