...
class ApiErrorInsufficientCapacity {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ApiErrorInsufficientCapacity &&
    other.code == code &&
  ...
  @override
  String toString() => 'ApiErrorInsufficientCapacity[code=$code, message=$message, suggestion=$suggestion]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ApiErrorInsufficientCapacity[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ApiErrorInsufficientCapacity[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ApiErrorInsufficientCapacity> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<ApiErrorInsufficientCapacity>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ApiErrorInsufficientCapacity>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ApiErrorInsufficientCapacity.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
