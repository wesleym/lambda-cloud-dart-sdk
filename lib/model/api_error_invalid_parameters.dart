...
class ApiErrorInvalidParameters {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ApiErrorInvalidParameters &&
    other.code == code &&
  ...
  @override
  String toString() => 'ApiErrorInvalidParameters[code=$code, message=$message, suggestion=$suggestion]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ApiErrorInvalidParameters[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ApiErrorInvalidParameters[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ApiErrorInvalidParameters> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<ApiErrorInvalidParameters>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ApiErrorInvalidParameters>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ApiErrorInvalidParameters.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
