...
class ApiErrorLaunchResourceNotFound {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ApiErrorLaunchResourceNotFound &&
    other.code == code &&
  ...
  @override
  String toString() => 'ApiErrorLaunchResourceNotFound[code=$code, message=$message, suggestion=$suggestion]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ApiErrorLaunchResourceNotFound[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ApiErrorLaunchResourceNotFound[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ApiErrorLaunchResourceNotFound> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<ApiErrorLaunchResourceNotFound>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ApiErrorLaunchResourceNotFound>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ApiErrorLaunchResourceNotFound.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
