...
class ApiErrorQuotaExceeded {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ApiErrorQuotaExceeded &&
    other.code == code &&
  ...
  @override
  String toString() => 'ApiErrorQuotaExceeded[code=$code, message=$message, suggestion=$suggestion]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ApiErrorQuotaExceeded[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ApiErrorQuotaExceeded[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ApiErrorQuotaExceeded> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<ApiErrorQuotaExceeded>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ApiErrorQuotaExceeded>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ApiErrorQuotaExceeded.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
