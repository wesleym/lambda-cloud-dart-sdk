...
class ApiErrorUnauthorized {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ApiErrorUnauthorized &&
    other.code == code &&
  ...
  @override
  String toString() => 'ApiErrorUnauthorized[code=$code, message=$message, suggestion=$suggestion]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ApiErrorUnauthorized[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ApiErrorUnauthorized[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ApiErrorUnauthorized> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<ApiErrorUnauthorized>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ApiErrorUnauthorized>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ApiErrorUnauthorized.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
