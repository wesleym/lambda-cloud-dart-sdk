...
class CreateFirewallRuleset409Response {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateFirewallRuleset409Response &&
    other.error == error;
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CreateFirewallRuleset409Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CreateFirewallRuleset409Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CreateFirewallRuleset409Response> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, CreateFirewallRuleset409Response> mapFromJson(dynamic json) {
  ...
  static Map<String, List<CreateFirewallRuleset409Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreateFirewallRuleset409Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreateFirewallRuleset409Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
