...
class DeleteSSHKey200Response {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DeleteSSHKey200Response &&
    other.data == data;
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "DeleteSSHKey200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "DeleteSSHKey200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DeleteSSHKey200Response> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<DeleteSSHKey200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<DeleteSSHKey200Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = DeleteSSHKey200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
