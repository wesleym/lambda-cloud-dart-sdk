...
class FilesystemCreateRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FilesystemCreateRequest &&
    other.name == name &&
    other.region == region;
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FilesystemCreateRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FilesystemCreateRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<FilesystemCreateRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<FilesystemCreateRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FilesystemCreateRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FilesystemCreateRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
