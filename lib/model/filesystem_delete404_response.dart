...
class FilesystemDelete404Response {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FilesystemDelete404Response &&
    other.error == error;
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FilesystemDelete404Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FilesystemDelete404Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<FilesystemDelete404Response> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<FilesystemDelete404Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FilesystemDelete404Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FilesystemDelete404Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
