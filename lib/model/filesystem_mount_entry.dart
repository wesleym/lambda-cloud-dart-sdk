...
class FilesystemMountEntry {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FilesystemMountEntry &&
  ...
  @override
  String toString() => 'FilesystemMountEntry[mountPoint=$mountPoint, fileSystemId=$fileSystemId]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FilesystemMountEntry[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FilesystemMountEntry[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<FilesystemMountEntry> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<FilesystemMountEntry>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FilesystemMountEntry>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FilesystemMountEntry.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
