...
class FirewallRule {
  ...
  @override
  String toString() => 'FirewallRule[protocol=$protocol, portRange=$portRange, sourceNetwork=$sourceNetwork, description=$description]';
    ...
    if (value is Map) {
      ...
      return FirewallRule(
        ...
        portRange: json[r'port_range'] is Iterable
            ? (json[r'port_range'] as Iterable).cast<int>().toList(growable: false)
            : const [],
