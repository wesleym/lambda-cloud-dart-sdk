...
class FirewallRulesetCreateRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FirewallRulesetCreateRequest &&
    other.name == name &&
    other.region == region &&
  ...
  @override
  String toString() => 'FirewallRulesetCreateRequest[name=$name, region=$region, rules=$rules]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FirewallRulesetCreateRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FirewallRulesetCreateRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<FirewallRulesetCreateRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<FirewallRulesetCreateRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FirewallRulesetCreateRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FirewallRulesetCreateRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
