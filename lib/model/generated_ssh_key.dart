...
class GeneratedSSHKey {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GeneratedSSHKey &&
    other.id == id &&
    other.name == name &&
  ...
  @override
  String toString() => 'GeneratedSSHKey[id=$id, name=$name, publicKey=$publicKey, privateKey=$privateKey]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GeneratedSSHKey[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GeneratedSSHKey[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GeneratedSSHKey> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<GeneratedSSHKey>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GeneratedSSHKey>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GeneratedSSHKey.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
