...
class GlobalFirewallRuleset {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GlobalFirewallRuleset &&
    other.id == id &&
    other.name == name &&
  ...
  @override
  String toString() => 'GlobalFirewallRuleset[id=$id, name=$name, rules=$rules]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GlobalFirewallRuleset[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GlobalFirewallRuleset[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GlobalFirewallRuleset> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<GlobalFirewallRuleset>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GlobalFirewallRuleset>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GlobalFirewallRuleset.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
