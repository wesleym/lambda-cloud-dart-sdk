...
class GlobalFirewallRulesetPatchRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GlobalFirewallRulesetPatchRequest &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GlobalFirewallRulesetPatchRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GlobalFirewallRulesetPatchRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GlobalFirewallRulesetPatchRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, GlobalFirewallRulesetPatchRequest> mapFromJson(dynamic json) {
  ...
  static Map<String, List<GlobalFirewallRulesetPatchRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GlobalFirewallRulesetPatchRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GlobalFirewallRulesetPatchRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
