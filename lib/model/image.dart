...
class Image {
  ...
  @override
  String toString() => 'Image[id=$id, createdTime=$createdTime, updatedTime=$updatedTime, name=$name, description=$description, family=$family, version=$version, architecture=$architecture, region=$region]';
