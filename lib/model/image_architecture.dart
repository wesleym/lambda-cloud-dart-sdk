...
class ImageArchitecture {
  ...
  static ImageArchitecture? fromJson(dynamic value) => ImageArchitectureTypeTransformer().decode(value);

  static List<ImageArchitecture> listFromJson(dynamic json, {bool growable = false,}) {
...
class ImageArchitectureTypeTransformer {
  factory ImageArchitectureTypeTransformer() => _instance ??= const ImageArchitectureTypeTransformer._();
  ...
  ImageArchitecture? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'x86_64': return ImageArchitecture.x8664;
        case r'arm64': return ImageArchitecture.arm64;
        default:
          if (!allowNull) {
