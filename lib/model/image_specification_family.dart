...
class ImageSpecificationFamily {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ImageSpecificationFamily &&
    other.family == family;
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ImageSpecificationFamily[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ImageSpecificationFamily[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ImageSpecificationFamily> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<ImageSpecificationFamily>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ImageSpecificationFamily>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ImageSpecificationFamily.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
