...
class Instance {
  ...
  @override
  String toString() => 'Instance[id=$id, name=$name, ip=$ip, privateIp=$privateIp, status=$status, sshKeyNames=$sshKeyNames, fileSystemNames=$fileSystemNames, fileSystemMounts=$fileSystemMounts, region=$region, instanceType=$instanceType, hostname=$hostname, jupyterToken=$jupyterToken, jupyterUrl=$jupyterUrl, actions=$actions, tags=$tags, firewallRulesets=$firewallRulesets]';
    ...
    if (value is Map) {
      ...
      return Instance(
        ...
        fileSystemNames: json[r'file_system_names'] is Iterable
            ...
            : const [],
        fileSystemMounts: FilesystemMountEntry.listFromJson(json[r'file_system_mounts']),
