...
class InstanceActionAvailability {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InstanceActionAvailability &&
  ...
  @override
  String toString() => 'InstanceActionAvailability[migrate=$migrate, rebuild=$rebuild, restart=$restart, coldReboot=$coldReboot, terminate=$terminate]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "InstanceActionAvailability[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "InstanceActionAvailability[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return InstanceActionAvailability(
        ...
        coldReboot: InstanceActionAvailabilityDetails.fromJson(json[r'cold_reboot'])!,
        terminate: InstanceActionAvailabilityDetails.fromJson(json[r'terminate'])!,
      );
    }
    return null;
  }

  static List<InstanceActionAvailability> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<InstanceActionAvailability>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InstanceActionAvailability>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InstanceActionAvailability.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
