...
class InstanceActionAvailabilityDetails {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InstanceActionAvailabilityDetails &&
  ...
  @override
  String toString() => 'InstanceActionAvailabilityDetails[available=$available, reasonCode=$reasonCode, reasonDescription=$reasonDescription]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "InstanceActionAvailabilityDetails[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "InstanceActionAvailabilityDetails[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return InstanceActionAvailabilityDetails(
        ...
        reasonCode: InstanceActionAvailabilityDetailsReasonCode.fromJson(json[r'reason_code']),
  ...
  static List<InstanceActionAvailabilityDetails> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, InstanceActionAvailabilityDetails> mapFromJson(dynamic json) {
  ...
  static Map<String, List<InstanceActionAvailabilityDetails>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InstanceActionAvailabilityDetails>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InstanceActionAvailabilityDetails.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
