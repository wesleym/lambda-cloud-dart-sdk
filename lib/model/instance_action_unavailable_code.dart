...
class InstanceActionUnavailableCode {
  ...
  static const hasNotLaunched = InstanceActionUnavailableCode._(r'vm-has-not-launched');
  static const isTooOld = InstanceActionUnavailableCode._(r'vm-is-too-old');
  static const isTerminating = InstanceActionUnavailableCode._(r'vm-is-terminating');
  ...
  static InstanceActionUnavailableCode? fromJson(dynamic value) => InstanceActionUnavailableCodeTypeTransformer().decode(value);

  static List<InstanceActionUnavailableCode> listFromJson(dynamic json, {bool growable = false,}) {
...
class InstanceActionUnavailableCodeTypeTransformer {
  factory InstanceActionUnavailableCodeTypeTransformer() => _instance ??= const InstanceActionUnavailableCodeTypeTransformer._();
  ...
  InstanceActionUnavailableCode? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'vm-has-not-launched': return InstanceActionUnavailableCode.hasNotLaunched;
        case r'vm-is-too-old': return InstanceActionUnavailableCode.isTooOld;
        case r'vm-is-terminating': return InstanceActionUnavailableCode.isTerminating;
        default:
          if (!allowNull) {
