...
class InstanceLaunchResponse {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InstanceLaunchResponse &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "InstanceLaunchResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "InstanceLaunchResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<InstanceLaunchResponse> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<InstanceLaunchResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InstanceLaunchResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InstanceLaunchResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
