...
class InstanceRestartResponse {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InstanceRestartResponse &&
  ...
  @override
  String toString() => 'InstanceRestartResponse[restartedInstances=$restartedInstances]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "InstanceRestartResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "InstanceRestartResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<InstanceRestartResponse> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<InstanceRestartResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InstanceRestartResponse>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InstanceRestartResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
