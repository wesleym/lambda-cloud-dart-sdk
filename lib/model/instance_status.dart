...
class InstanceStatus {
  ...
  static InstanceStatus? fromJson(dynamic value) => InstanceStatusTypeTransformer().decode(value);

  static List<InstanceStatus> listFromJson(dynamic json, {bool growable = false,}) {
...
class InstanceStatusTypeTransformer {
  factory InstanceStatusTypeTransformer() => _instance ??= const InstanceStatusTypeTransformer._();
  ...
  InstanceStatus? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'booting': return InstanceStatus.booting;
        case r'active': return InstanceStatus.active;
        case r'unhealthy': return InstanceStatus.unhealthy;
        case r'terminated': return InstanceStatus.terminated;
        case r'terminating': return InstanceStatus.terminating;
        case r'preempted': return InstanceStatus.preempted;
        default:
          if (!allowNull) {
