...
class InstanceTypesItem {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is InstanceTypesItem &&
    other.instanceType == instanceType &&
    _deepEquality.equals(other.regionsWithCapacityAvailable, regionsWithCapacityAvailable);

  @override
  int get hashCode =>
    // ignore: unnecessary_parenthesis
    (instanceType.hashCode) +
    (regionsWithCapacityAvailable.hashCode);

  @override
  String toString() => 'InstanceTypesItem[instanceType=$instanceType, regionsWithCapacityAvailable=$regionsWithCapacityAvailable]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'instance_type'] = this.instanceType;
      json[r'regions_with_capacity_available'] = this.regionsWithCapacityAvailable;
    return json;
  }
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "InstanceTypesItem[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "InstanceTypesItem[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return InstanceTypesItem(
        ...
        regionsWithCapacityAvailable: Region.listFromJson(json[r'regions_with_capacity_available']),
      );
    }
    return null;
  }

  static List<InstanceTypesItem> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<InstanceTypesItem>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<InstanceTypesItem>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = InstanceTypesItem.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
