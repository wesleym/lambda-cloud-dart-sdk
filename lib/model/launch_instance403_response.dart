...
class LaunchInstance403Response {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LaunchInstance403Response &&
    other.error == error;
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "LaunchInstance403Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "LaunchInstance403Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<LaunchInstance403Response> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<LaunchInstance403Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<LaunchInstance403Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = LaunchInstance403Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
