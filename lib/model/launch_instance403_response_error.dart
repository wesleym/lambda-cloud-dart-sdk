...
class LaunchInstance403ResponseError {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LaunchInstance403ResponseError &&
    other.code == code &&
  ...
  @override
  String toString() => 'LaunchInstance403ResponseError[code=$code, message=$message, suggestion=$suggestion]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "LaunchInstance403ResponseError[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "LaunchInstance403ResponseError[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<LaunchInstance403ResponseError> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<LaunchInstance403ResponseError>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<LaunchInstance403ResponseError>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = LaunchInstance403ResponseError.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
