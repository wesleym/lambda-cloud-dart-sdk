...
class ListInstances401Response {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ListInstances401Response &&
    other.error == error;
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ListInstances401Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ListInstances401Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ListInstances401Response> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<ListInstances401Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ListInstances401Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ListInstances401Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
