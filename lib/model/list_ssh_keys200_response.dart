...
class ListSSHKeys200Response {
  /// Returns a new [ListSSHKeys200Response] instance.
  ...
  @override
  String toString() => 'ListSSHKeys200Response[data=$data]';
  ...
  /// Returns a new [ListSSHKeys200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ListSSHKeys200Response? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ListSSHKeys200Response> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ListSSHKeys200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ListSSHKeys200Response> mapFromJson(dynamic json) {
    final map = <String, ListSSHKeys200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ListSSHKeys200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
