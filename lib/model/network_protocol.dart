...
class NetworkProtocol {
  ...
  static NetworkProtocol? fromJson(dynamic value) => NetworkProtocolTypeTransformer().decode(value);

  static List<NetworkProtocol> listFromJson(dynamic json, {bool growable = false,}) {
...
class NetworkProtocolTypeTransformer {
  factory NetworkProtocolTypeTransformer() => _instance ??= const NetworkProtocolTypeTransformer._();
  ...
  NetworkProtocol? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'tcp': return NetworkProtocol.tcp;
        case r'udp': return NetworkProtocol.udp;
        case r'icmp': return NetworkProtocol.icmp;
        case r'all': return NetworkProtocol.all;
        default:
          if (!allowNull) {
