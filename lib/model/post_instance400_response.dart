...
class PostInstance400Response {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PostInstance400Response &&
    other.error == error;
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PostInstance400Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PostInstance400Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PostInstance400Response> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<PostInstance400Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PostInstance400Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PostInstance400Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
