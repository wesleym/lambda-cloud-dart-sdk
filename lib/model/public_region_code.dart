...
class PublicRegionCode {
  ...
  static PublicRegionCode? fromJson(dynamic value) => PublicRegionCodeTypeTransformer().decode(value);

  static List<PublicRegionCode> listFromJson(dynamic json, {bool growable = false,}) {
...
class PublicRegionCodeTypeTransformer {
  factory PublicRegionCodeTypeTransformer() => _instance ??= const PublicRegionCodeTypeTransformer._();
  ...
  PublicRegionCode? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'europe-central-1': return PublicRegionCode.europeCentral1;
        case r'asia-south-1': return PublicRegionCode.asiaSouth1;
        case r'australia-east-1': return PublicRegionCode.australiaEast1;
        case r'me-west-1': return PublicRegionCode.meWest1;
        case r'asia-northeast-1': return PublicRegionCode.asiaNortheast1;
        case r'asia-northeast-2': return PublicRegionCode.asiaNortheast2;
        case r'us-east-1': return PublicRegionCode.usEast1;
        case r'us-west-2': return PublicRegionCode.usWest2;
        case r'us-west-1': return PublicRegionCode.usWest1;
        case r'us-south-1': return PublicRegionCode.usSouth1;
        case r'us-west-3': return PublicRegionCode.usWest3;
        case r'us-midwest-1': return PublicRegionCode.usMidwest1;
        case r'us-east-2': return PublicRegionCode.usEast2;
        case r'us-south-2': return PublicRegionCode.usSouth2;
        case r'us-south-3': return PublicRegionCode.usSouth3;
        case r'us-east-3': return PublicRegionCode.usEast3;
        case r'us-midwest-2': return PublicRegionCode.usMidwest2;
        case r'test-east-1': return PublicRegionCode.testEast1;
        case r'test-west-1': return PublicRegionCode.testWest1;
        default:
          if (!allowNull) {
