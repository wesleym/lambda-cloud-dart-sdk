...
class RequestedFilesystemMountEntry {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RequestedFilesystemMountEntry &&
  ...
  int get hashCode =>
    ...
    (mountPoint.hashCode) +
    (fileSystemId.hashCode);

  @override
  String toString() => 'RequestedFilesystemMountEntry[mountPoint=$mountPoint, fileSystemId=$fileSystemId]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RequestedFilesystemMountEntry[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RequestedFilesystemMountEntry[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<RequestedFilesystemMountEntry> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<RequestedFilesystemMountEntry>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RequestedFilesystemMountEntry>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RequestedFilesystemMountEntry.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
