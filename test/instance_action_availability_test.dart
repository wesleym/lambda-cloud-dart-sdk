...
// tests for InstanceActionAvailability
void main() {
  // final instance = InstanceActionAvailability();

  group('test InstanceActionAvailability', () {
    ...
    test('to test the property `migrate`', () async {
      // TODO
    });
    ...
    test('to test the property `rebuild`', () async {
      // TODO
    });
    ...
    test('to test the property `restart`', () async {
      // TODO
    });
    ...
    test('to test the property `coldReboot`', () async {
      // TODO
    });
    ...
    test('to test the property `terminate`', () async {
      // TODO
    });
